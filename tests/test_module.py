...
class TestLinuxUserspaceCoreDump(TestCase):
    def test_loaded_modules(self):
        ...
        with self.subTest(module="crashme"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FE154D29000, 0x7FE154D2D028)
            )
            self.assertEqual(
        ...
        with self.subTest(module="libc"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FE154B39000, 0x7FE154D15D50)
            )
            self.assertEqual(
        ...
        with self.subTest(module="ld-linux"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FE154D30000, 0x7FE154D662B8)
            )
            self.assertEqual(
        ...
        with self.subTest(module="vdso"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FFEB18EC000, 0x7FFEB18ECD5D)
            )
            self.assertEqual(
    ...
    def test_loaded_modules_pie(self):
        ...
        with self.subTest(module="main"):
            ...
            self.assertEqual(
                (module.start, module.end), (0x55B3F015A000, 0x55B3F015E030)
            )
            self.assertEqual(
        ...
        with self.subTest(module="crashme"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FB63CE40000, 0x7FB63CE44028)
            )
            self.assertEqual(
                module.build_id.hex(), "045686d8fbc29df343dd452fc3b35de12cca3a7e"
            )
        ...
        with self.subTest(module="libc"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FB63CC50000, 0x7FB63CE2CD50)
            )
            self.assertEqual(
                module.build_id.hex(), "81daba31ee66dbd63efdc4252a872949d874d136"
            )
        ...
        with self.subTest(module="ld-linux"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FB63CE47000, 0x7FB63CE7D2B8)
            )
            self.assertEqual(
                module.build_id.hex(), "bb6fec54c7521fddc569a2f4e141dfb97bf3acbe"
            )
        ...
        with self.subTest(module="vdso"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FFF5557C000, 0x7FFF5557CD5D)
            )
            self.assertEqual(
                module.build_id.hex(), "320b9b38597b3c1894dc1a40674729b29a2de12c"
            )
    ...
    def test_loaded_modules_static(self):
        ...
        with self.subTest(module="vdso"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FFC12B53000, 0x7FFC12B53D5D)
            )
            self.assertEqual(
                module.build_id.hex(), "320b9b38597b3c1894dc1a40674729b29a2de12c"
            )
    ...
    def test_loaded_modules_static_pie(self):
        ...
        with self.subTest(module="main"):
            ...
            self.assertEqual(
                (module.start, module.end), (0x7F9FA3F4B000, 0x7F9FA3F4F298)
            )
            self.assertEqual(
        ...
        with self.subTest(module="vdso"):
            ...
            found_modules.append(module)
            self.assertEqual(
                (module.start, module.end), (0x7FFD67DF1000, 0x7FFD67DF1D5D)
            )
            self.assertEqual(
                module.build_id.hex(), "320b9b38597b3c1894dc1a40674729b29a2de12c"
            )
